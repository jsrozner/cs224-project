...
def add_common_args(parser):
    ...
    parser.add_argument('--train_record_file',              # generated by setup.py in build_features()
                        type=str,
                        default='./data/train.npz')
    parser.add_argument('--dev_record_file',                # same as above
                        type=str,
                        default='./data/dev.npz')
    parser.add_argument('--test_record_file',               # same as above
                        type=str,
                        default='./data/test.npz')
    parser.add_argument('--word_emb_file',                  # generated by setup.py after get_embedding()
                        type=str,
...
def add_train_test_args(parser):
    ...
    parser.add_argument('--load_path',                              # Loads the BiDAF model from checkpoint
                        type=str,
                        default=None,
